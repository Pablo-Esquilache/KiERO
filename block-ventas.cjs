...
// Add CajasAPI to imports
if (!js.includes('CajasAPI')) {
    js = js.replace('DevolucionesAPI,', 'DevolucionesAPI,\\n  CajasAPI,');
}
...
if (!js.includes('BLOQUEO DE VENTAS SIN CAJA ABIERTA')) {
    js = js.replace('// --- GLOBAL STATE FOR MODALS ---', blockCode + '\n// --- GLOBAL STATE FOR MODALS ---');
